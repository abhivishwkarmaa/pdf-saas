...
> = {
  ...
  image: {
    label: "Image Tools",
    description: "Compress, resize, crop, convert, and edit images professionally",
  },
  text: {
    label: "Text Tools",
...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    slug: "image-to-jpg",
    name: "Convert to JPG",
    description: "Convert all types of images (PNG, WebP, HEIC, BMP, GIF, AVIF, SVG) to JPG",
    category: "image",
    tier: "sync",
    kind: "file",
    maxFiles: 20,
  ...
  {
    slug: "jpg-to-image",
    name: "Convert JPG to All Images",
    description: "Convert JPG photos into PNG, WebP, BMP, GIF, AVIF, and other formats",
    category: "image",
    tier: "sync",
    kind: "file",
    maxFiles: 20,
  ...
  },
  {
    slug: "gif-to-png",
    name: "GIF to PNG",
    description: "Convert GIF frames to crisp PNG images",
    category: "image",
    tier: "sync",
    kind: "file",
    maxFiles: 10,
  ...
  },
  {
    slug: "svg-to-jpg",
    name: "SVG to JPG",
    description: "Rasterize SVG vector graphics into high-resolution JPG images",
    category: "image",
    tier: "sync",
    kind: "file",
    maxFiles: 10,
  ...
  },
  {
    ...
    maxFiles: 20,
    maxMb: 50,
    accept: [".jpg", ".jpeg", ".png", ".webp", ".gif", "image/jpeg", "image/png", "image/webp", "image/jpg", "image/gif"],
    enabled: true,
    phase: 2,
  },
  ...
  // ─── Image Editor ────────────────────────────────────────────
  {
    slug: "image-editor",
    name: "Image Editor",
    description: "Professional Canva-style image editor — layers, filters, text, AI tools, and more",
    category: "image",
    tier: "sync",
    kind: "file",
    maxFiles: 1,
